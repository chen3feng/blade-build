...
class TestCcPlugin(unittest.TestCase):
    """Test cc_plugin """
    def setUp(self):
        """setup method. """
        self.command = 'build'
        self.targets = ['test_cc_plugin/...']
        self.target_path = 'test_cc_plugin'
    ...
    def testGenerateRules(self):
        ...
        self.assertTrue('-fPIC -shared' in string_plugin_depends_libs)
