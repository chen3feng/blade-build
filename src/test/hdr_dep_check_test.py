...
class TestHdrDepCheck(blade_test.TargetTest):
    ...
    def testErrorReport(self):
        ...
        self.assertTrue(self.inBuildOutput('''For "hdr_dep_check/lib1.h", which belongs to "//hdr_dep_check:lib1"'''))
        self.assertTrue(self.inBuildOutput('''"hdr_dep_check/lib1_impl.h" is a private header file of "//hdr_dep_check:lib1"'''))
