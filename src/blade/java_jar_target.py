...
def get_java_jar_dep_source_map():
    ...
    """
    return java_jar_dep_source_map


def get_java_jar_files_packing_map():
    """The map to hold the files that should be packed into java jar. """
    return java_jar_files_packing_map


def get_java_jars_map():
    """The map to hold the java jar files generated by blade. """
    return java_jars_map


def get_java_classpath_map():
    """The classpath list which is needed by java compling. """
    return java_classpath_map


def get_java_jar_dep_vars():
...
class JavaJarTarget(Target):
    ...
    def _dep_is_jar_to_compile(self, dep):
        ...
        target_type = targets[dep].data.get('type')
    ...
    def _java_jar_rules_make_jar(self, pack_list, classes_var_list):
        ...
        for class_path in pack_list:
            ...
            self._write_rule('%s = %s.BladeJar(["%s"], "%s")' % (
                    ...
                    jar_target,
                    build_file_dst))
            java_jars_map[self.key].append(jar_target)
