...
* hdrs
  ...
  For problems that existed before hdrs support, you can use [`cc_library_config.hdrs_missing_suppress`](../config.md#cc_library_config) to suppress them.
...
The main difference between foreign_cc_library and prebuilt_cc_library is that the library it describes is dynamically generated by Blade during the build by calling other build systems,
